          ...
          <>
            ...
            >
              <Disclosure.Panel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-[#c86b38]">
                  <h3 className="text-lg text-white">
                    Comment pourrions-nous vous aider?
                  </h3>
                  <p className="text-white opacity-50">
                    On répond d'habitude en quelques heures.
                  </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          {...register("name", {
                            required: "Le nom complet est nécessaire",
                            maxLength: 80,
                          })}
                          className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.name
                              ? "border-red-600 focus:border-red-600 ring-red-100"
                              : "border-gray-300 focus:border-[#c86b38] ring-indigo-100"
                          }`}
                        />
                        {errors.name && (
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          id="email"
                          {...register("email", {
                            required: "Taper un courriel valide",
                            pattern: {
                              value: /^\S+@\S+$/i,
                              message: "Taper un courriel valide",
                            },
                          })}
                          placeholder="jean.pierre@gmail.com"
                          className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.email
                              ? "border-red-600 focus:border-red-600 ring-red-100"
                              : "border-gray-300 focus:border-[#c86b38] ring-indigo-100"
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-[#c86b38] rounded-md focus:bg-[#c86b38] focus:outline-none"
                        >
                          {isSubmitting ? (
                            <svg
                  ...
                  {isSubmitSuccessful && isSuccess && (
                    <>
                      <div className="flex flex-col items-center justify-center h-full text-center text-white rounded-md">
                        ...
                        <button
                          className="mt-6 text-[#c86b38] focus:outline-none"
                          onClick={() => reset()}
                        >
                          Retour
                        </button>
